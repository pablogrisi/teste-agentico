...
**TSD associada (frontend):** `docs/engineering/specs/011-nova-analise-frontend.tsd.md`.
...
**TSD associada (frontend):** `docs/engineering/specs/010-listagem-analises-frontend.tsd.md`.
