...
1. **Backend (Pablo):** ciclo **RF-012 + RF-013 + RF-015** aberto (`backend/rf-012-conclusao`). PM apresentou a User Story — **validar antes de o Engenheiro escrever a TSD-010**.
