...
updated: 01/09/2026 // Vinicius Andrade (RF-008 frontend / TSD-016)
---
...
- **Frontend: RF-008 / TSD-016 mergeada na `main`** (branch `frontend/rf-008-parecer`; RF-009/TSD-015 já em `2e8f6d5`). Próximo ciclo de frontend: **RF-011** (marcar "verificado" interativo) — PM apresenta a User Story + TSD para validação antes de implementar.
