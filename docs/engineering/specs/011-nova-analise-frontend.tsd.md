...
- docs/engineering/specs/010-listagem-analises-frontend.tsd.md
...
- `docs/engineering/specs/010-listagem-analises-frontend.tsd.md` — seam de dados, toolbar
...
```text
Leia START_HERE.md, .ai-dev/context-map.md, esta TSD (011), a TSD-004 (contrato) e a TSD-010.
